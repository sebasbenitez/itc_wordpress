...
class ZipStreamTest extends TestCase
{
    ...
    {
        $this->expectException(\WOE\ZipStream\Exception\FileNotFoundException::class);
    ...
    public function testFileNotReadableException(): void
    {
        ...
        $zip = new ZipStream();
        $this->expectException(\WOE\ZipStream\Exception\FileNotReadableException::class);

<?php
/*
	Plugin Name: Wanderlust Andreani Shipping - Premium
...
*/
function wanderlust_andreani_start() {
	global $wp_session;
}
add_action('init','wanderlust_andreani_start');
...
function wc_andreani_plugin_links( $links ) {
	...
	$plugin_links = array(
		'<a href="https://wanderlust-webdesign.com/">' . __( 'Soporte', 'woocommerce-shipping-andreani' ) . '</a>',
	);

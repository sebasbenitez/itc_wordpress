...
class AdminTranslations
{
    ...
    private function setTicketGatewaySettingsTranslations(): void
    {
        ...
        $this->ticketGatewaySettings = [
            ...
            'enabled_descriptions_enabled' => __('The transparent checkout for tickets is <b>enabled</b>.', 'woocommerce-mercadopago'),
            'enabled_descriptions_disabled' => __('The transparent checkout for tickets is <b>disabled</b>.', 'woocommerce-mercadopago'),
            'title_title'                  => __('Title in the store Checkout', 'woocommerce-mercadopago'),
            'title_description'            => __('Change the display text in Checkout, maximum characters: 85', 'woocommerce-mercadopago'),
    ...
    private function setPseGatewaySettingsTranslations(): void
    {
        ...
        $this->pseGatewaySettings = [
            ...
            'enabled_descriptions_enabled' => __('The transparent checkout for PSE is <b>enabled</b>.', 'woocommerce-mercadopago'),
            'enabled_descriptions_disabled' => __('The transparent checkout for PSE is <b>disabled</b>.', 'woocommerce-mercadopago'),
            'title_title'                  => __('Title in the store Checkout', 'woocommerce-mercadopago'),
            'title_description'            => __('Change the display text in Checkout, maximum characters: 85', 'woocommerce-mercadopago'),

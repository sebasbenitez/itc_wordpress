<?php
/**
 * The template for displaying product info in the product quick view.
 */
...
<div class="wd-product-wrapper product-wrapper">
	<div class="wd-product-thumb product-element-top wd-quick-shop">
		...
		<?php
		do_action( 'woodmart_shop_loop_product_thumbnail' );
		...
		<?php if ( has_action( 'woodmart_add_loop_btn' ) ) : ?>
			<div class="wd-add-btn wd-add-btn-replace">
				...
				<?php echo woodmart_get_thumbnails_gallery_pagin(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
			</div>
		<?php else : ?>
			<?php echo woodmart_get_thumbnails_gallery_pagin(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>
		<?php endif; ?>

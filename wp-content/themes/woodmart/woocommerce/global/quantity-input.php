...
<div class="quantity<?php echo 'hidden' === $type ? ' hidden' : ''; ?>">
	...
	<?php if ( 'number' === $type ) : ?>
		<button class="minus btn" aria-label="<?php esc_attr_e( 'Decrease quantity', 'woodmart' ); ?>">-</button>
	<?php endif; ?>
	...
	<?php if ( 'number' === $type ) : ?>
		<button class="plus btn" aria-label="<?php esc_attr_e( 'Increase quantity', 'woocommerce' ); ?>">+</button>
	<?php endif; ?>

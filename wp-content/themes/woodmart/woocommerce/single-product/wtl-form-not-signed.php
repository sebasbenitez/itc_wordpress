...
<div class="wd-wtl-form<?php echo esc_attr( $wrapper_classes ); ?>" data-state="not-signed">
	...
	<div class="wd-wtl-form-fields">
		<input type="email" name="wd-wtl-user-subscribe-email" placeholder="<?php esc_attr_e( 'Enter your email address', 'woodmart' ); ?>" <?php echo $email_attr; // phpcs:ignore. ?> />
	...
	<?php if ( woodmart_get_opt( 'waitlist_enable_privacy_checkbox', '1' ) ) : ?>
		...
		?>
		<label>
			<input type="checkbox" name="wd-wtl-policy-check" class="wd-wtl-policy-check" value="0">
			<span>

...
<div <?php wc_product_cat_class( $args['classes'], $args['category'] ); ?> data-loop="<?php echo esc_attr( $args['woocommerce_loop'] ); ?>">
	...
	<div class="wd-cat-inner wrapp-category">
		<div class="wd-cat-thumb category-image-wrapp">
			<a class="wd-cat-image category-image" href="<?php echo esc_url( get_term_link( $args['category'], 'product_cat' ) ); ?>" aria-label="<?php echo esc_html( $args['category']->name ); ?>">
		...
		<div class="wd-cat-content hover-mask">
			...
			<?php if ( ! woodmart_loop_prop( 'hide_categories_product_count' ) ) : ?>
				<div class="wd-cat-count more-products">
					<a href="<?php echo esc_url( get_term_link( $args['category'], 'product_cat' ) ); ?>">
					<?php
		...
		<a class="wd-fill category-link" href="<?php echo esc_url( get_term_link( $args['category'], 'product_cat' ) ); ?>" aria-label="<?php echo esc_attr( sprintf( __( 'Product category %s', 'woodmart' ), $args['category']->slug ) ); ?>"></a>

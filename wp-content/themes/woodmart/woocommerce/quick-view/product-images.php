...
<div class="wd-carousel-container wd-gallery-images">
	<div class="wd-carousel-inner">
		<div class="woocommerce-product-gallery__wrapper images quick-view-gallery wd-carousel wd-grid">
			<?php
				$attributes = array(
				...
				if ( has_post_thumbnail() ) {
					...
					echo '<figure class="woocommerce-product-gallery__image--placeholder">' . apply_filters( 'woocommerce_single_product_image_html', sprintf( '<img src="%s" alt="%s" />', wc_placeholder_img_src(), __( 'Placeholder', 'woodmart' ) ), $post->ID ) . '</figure>'; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
				}
				?>

				<a href="<?php echo esc_url( get_permalink() ); ?>" class="btn btn-accent view-details-btn">

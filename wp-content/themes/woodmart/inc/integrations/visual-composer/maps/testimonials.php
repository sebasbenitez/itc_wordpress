...
if ( ! function_exists( 'woodmart_get_vc_map_testimonials' ) ) {
	/**
	 * Get map for Testimonials element
	 *
	 * @return array
	 */
...
if ( ! function_exists( 'woodmart_get_vc_map_testimonial' ) ) {
	/**
	 * Get map for Testimonial element
	 *
	 * @return array
	 */
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	class WPBakeryShortCode_testimonials extends WPBakeryShortCodesContainer { // phpcs:ignore
	}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_testimonial extends WPBakeryShortCode {// phpcs:ignore
	}
}

...
if ( ! function_exists( 'woodmart_get_social_buttons_shortcode_args' ) ) {
	/**
	 * Get Visual Composer map configuration for Social buttons element.
	 *
	 * @return array
	 */
...
if ( ! function_exists( 'woodmart_get_social_shortcode_params' ) ) {
	...
	function woodmart_get_social_shortcode_params() {
		...
		return apply_filters(
			'woodmart_get_social_shortcode_params',
			array(
				/**
				* Type
				*/
				...
				*/
				...
				function_exists( 'woodmart_get_typography_map' ) ? $typography['text_decoration'] : '',

<?php // phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound
/**
...
if ( ! function_exists( 'woodmart_get_vc_map_table' ) ) {
	/**
	 * Get Visual Composer map configuration for Table element.
	 *
	 * @return array
	 */
...
if ( ! function_exists( 'woodmart_get_vc_map_table_row' ) ) {
	/**
	 * Get Visual Composer map configuration for Table row element.
	 *
	 * @return array
	 */
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	/**
	 * WPBakeryShortCode_woodmart_table class.
	 */
	class WPBakeryShortCode_woodmart_table extends WPBakeryShortCodesContainer {} // phpcs:ignore.
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if ( class_exists( 'WPBakeryShortCode' ) ) {
	/**
	 * WPBakeryShortCode_woodmart_table_row class.
	 */
	class WPBakeryShortCode_woodmart_table_row extends WPBakeryShortCode {} // phpcs:ignore.
}

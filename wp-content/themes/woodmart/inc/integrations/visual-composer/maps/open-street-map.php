		...
		return array(
			...
			'params'          => array(
				...
				array(
					...
					'description' => sprintf(
						// translators: %1$s and %2$s are opening and closing anchor tags, %3$s is line break tag, %4$s is example of URL. Do not remove them.
				...
				array(
					'type'             => 'textfield',
					'heading'          => esc_html__( 'Placeholder resolution', 'woodmart' ),
					'group'            => esc_html__( 'Content', 'woodmart' ),

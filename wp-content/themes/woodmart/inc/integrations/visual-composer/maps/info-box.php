...
if ( ! function_exists( 'woodmart_get_vc_map_info_box_carousel' ) ) {
	/**
	 * Get the map for the information box carousel element.
	 */
...
if ( ! function_exists( 'woodmart_get_woodmart_info_box_shortcode_args' ) ) {
	/**
	 * Get the arguments for the information box shortcode.
	 */
...
if ( ! function_exists( 'woodmart_get_info_box_shortcode_params' ) ) {
	/**
	 * Get the parameters for the information box shortcode.
	 */
	function woodmart_get_info_box_shortcode_params() {
		...
		return apply_filters(
			...
			array(
				...
				array(
					'type'             => 'textfield',
					'heading'          => esc_html__( 'Hover background image resolution', 'woodmart' ),
...
// phpcs:disable WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound, PEAR.NamingConventions.ValidClassName.Invalid, Universal.Files.SeparateFunctionsFromOO.Mixed, Generic.Files.OneObjectStructurePerFile.MultipleFound

if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	/**
	 * Shortcode name must be in format: WPBakeryShortCode_[your_base_name_from_mapping]
	 */
...
// phpcs:enable WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedClassFound, PEAR.NamingConventions.ValidClassName.Invalid, Universal.Files.SeparateFunctionsFromOO.Mixed, Generic.Files.OneObjectStructurePerFile.MultipleFound

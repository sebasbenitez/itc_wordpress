...
if ( ! function_exists( 'woodmart_get_banner_params' ) ) {
	...
	function woodmart_get_banner_params() {
		...
		$highlight_typography = woodmart_get_typography_map(
			array(
		...
		return apply_filters(
			...
			array(
				...
				*/
				...
				$highlight_typography['font_family'],
				$highlight_typography['font_size'],
				$highlight_typography['font_weight'],
				$highlight_typography['text_transform'],
				$highlight_typography['font_style'],
				$highlight_typography['text_decoration'],
				$highlight_typography['line_height'],

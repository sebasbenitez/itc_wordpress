...
if ( ! function_exists( 'woodmart_get_vc_map_extra_menu' ) ) {
	/**
	 * Get Visual Composer map configuration for Extra menu element.
	 *
	 * @return array
	 */
	function woodmart_get_vc_map_extra_menu() {
		...
		return array(
			...
			'params'                  => array(
				...
				$items_typography['text_decoration'],
...
if ( ! function_exists( 'woodmart_get_vc_map_extra_menu_list' ) ) {
	/**
	 * Get Visual Composer map configuration for Extra menu list element.
	 *
	 * @return array
	 */
...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
	class WPBakeryShortCode_extra_menu extends WPBakeryShortCodesContainer { // phpcs:ignore.
	}
}

// Replace Wbc_Inner_Item with your base name from mapping for nested element
if ( class_exists( 'WPBakeryShortCode' ) ) {
	class WPBakeryShortCode_extra_menu_list extends WPBakeryShortCode { // phpcs:ignore.
	}
}

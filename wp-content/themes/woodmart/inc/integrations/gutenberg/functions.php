...
if ( ! function_exists( 'woodmart_gutenberg_editor_custom_styles' ) ) {
	...
	function woodmart_gutenberg_editor_custom_styles() {
		...
		wp_enqueue_style( 'wd-gutenberg-editor-style', WOODMART_THEME_DIR . '/css/parts/wp-editor' . $rtl . '.css', array(), woodmart_get_theme_info( 'Version' ) );

		if ( woodmart_is_gutenberg_blocks_enabled() ) {
			wp_enqueue_style( 'wd-gutenberg-editor-blocks-style', WOODMART_THEME_DIR . '/css/parts/wp-editor-blocks' . $rtl . '.css', array(), woodmart_get_theme_info( 'Version' ) );
		}

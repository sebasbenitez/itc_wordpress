...
class Ui extends Singleton {
	...
	public function wishlist_page_content( $wishlist = false ) {
		...
		if ( 'custom' !== woodmart_get_opt( 'products_hover_type' ) || ! woodmart_get_opt( 'product_custom_hover' ) ) {
			$args['products_bordered_grid']       = woodmart_get_opt( 'products_bordered_grid', 0 );
			$args['products_bordered_grid_style'] = woodmart_get_opt( 'products_bordered_grid_style' );
			$args['products_with_background']     = woodmart_get_opt( 'products_with_background' );
			$args['products_shadow']              = woodmart_get_opt( 'products_shadow' );
			$args['products_color_scheme']        = woodmart_get_opt( 'products_color_scheme', 'default' );
		}

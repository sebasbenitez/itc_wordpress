...
class Wishlists_Group extends Singleton {
	...
	public function wishlist_create_group_popup() {
		...
		?>
		<div class="wd-popup wd-popup-wishlist wd-deferred wd-scroll-content" role="complementary" aria-label="<?php esc_attr_e( 'Wishlist', 'woodmart' ); ?>">
			...
			<div class="wd-wishlist-add-success wd-set-mb reset-last-child">
				...
				<a href="<?php echo esc_url( woodmart_get_wishlist_page_url() ); ?>" class="wd-wishlist-back-to-lists btn btn-accent">
			...
			<a href="#" data-group-id="save" class="btn btn-accent wd-wishlist-save-btn" data-added-text="<?php esc_attr_e( 'Add to wishlist', 'woodmart' ); ?>" data-create-text="<?php esc_attr_e( 'Create wishlist', 'woodmart' ); ?>" data-move-text="<?php esc_attr_e( 'Move to wishlist', 'woodmart' ); ?>">
				<?php esc_html_e( 'Add to wishlist', 'woodmart' ); ?>
			</a>
			<a href="#" class="wd-wishlist-back-btn btn">
	...
	public function output_header_for_wishlist_groups() {
		...
		<div class="wd-wishlist-head wd-border-off">
			...
			<a href="#" class="btn btn-accent wd-wishlist-create-group-btn">
				<?php esc_html_e( 'Create wishlist', 'woodmart' ); ?>
			</a>
		</div>
		<?php

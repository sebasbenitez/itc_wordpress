...
class Product_Reviews extends Singleton {
	...
	public function add_options() {
		...
		Options::add_field(
			array(
				...
				'options'     => array(
					'one-column' => array(
						'name'  => esc_html__( 'One column', 'woodmart' ),
						'value' => 'one-column',
					),
					'two-column' => array(
						'name'  => esc_html__( 'Two column', 'woodmart' ),
						'value' => 'two-column',
					),
				),
				'default'     => 'two-column',
		...
		Options::add_field(
			array(
				...
				'default'     => 'style-1',
				'tags'        => array(
					esc_html__( 'review style', 'woodmart' ),
					esc_html__( 'comment design', 'woodmart' ),
				),
				'priority'    => 70,
			)
		);
	...
	public function include_files() {
		...
		foreach ( $files as $file ) {
			$file_path = WOODMART_THEMEROOT . '/inc/integrations/woocommerce/modules/product-reviews/' . $file . '.php';

	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} .wd-accordion-title.wd-active .wd-accordion-title-text, {{WRAPPER}} .wd-accordion:not(.wd-inited,[data-state="all_closed"]) .wd-accordion-item:first-child .wd-accordion-title-text' => 'color: {{VALUE}}',
				),
				'condition' => array(
					'title_text_color_scheme' => 'custom',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'size_units' => array( 'px' ),
				'selectors'  => array(
					'{{WRAPPER}} > div > .wd-accordion > .wd-accordion-item > .wd-accordion-title > .wd-accordion-opener' => 'font-size: {{SIZE}}{{UNIT}};',
				),
			)
		);

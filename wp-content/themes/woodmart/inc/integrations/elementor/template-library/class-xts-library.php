...
class XTS_Library {
	...
	public function get_templates() {
		if ( ! current_user_can( 'edit_posts' ) ) {
			return new \WP_Error( 'permission_error', 'You do not have permission to access this data.' );
		}
		...
		do_action( 'elementor/template-library/before_get_source_data', $args, $source ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores

		$data = $source->get_data( $args );

		do_action( 'elementor/template-library/after_get_source_data', $args, $source ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores

...
Options::add_field(
	array(
		'id'       => 'products_hover_type',
		'name'     => esc_html__( 'Product layout type for grid', 'woodmart' ),
		'type'     => 'buttons',
		'section'  => 'products_styles_section',
		'default'  => 'predefined',
		'options'  => array(
			'predefined' => array(
				'name'  => esc_html__( 'Predefined', 'woodmart' ),
				'value' => 'predefined',
			),
			'custom'     => array(
		...
		'tags'     => array(
			esc_html__( 'hover effect', 'woodmart' ),
			esc_html__( 'grid style', 'woodmart' ),
			esc_html__( 'loop design', 'woodmart' ),
		),
		'priority' => 5,
	)
);
...
Options::add_field(
	array(
		'id'           => 'product_custom_hover',
		'name'         => esc_html__( 'Custom product layout for grid', 'woodmart' ),
		'type'         => 'select',
		'section'      => 'products_styles_section',
		'select2'      => true,
		'empty_option' => true,
		'callback'     => 'woodmart_get_theme_settings_product_loop_items_array',
		...
		'tags'         => array(
			esc_html__( 'hover builder', 'woodmart' ),
			esc_html__( 'custom hover layout', 'woodmart' ),
			esc_html__( 'item design', 'woodmart' ),
		),
		'requires'     => array(
			array(
				'key'     => 'products_hover_type',
				'compare' => 'equals',
				'value'   => 'custom',
			),
		),
...
Options::add_field(
	array(
		'id'          => 'products_hover',
		'name'        => esc_html__( 'Predefined product layout for grid', 'woodmart' ),
		'description' => esc_html__( 'Choose one of those predefined product layouts for grid.', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_styles_section',
		'default'     => 'base',
		'options'     => array(
		...
		'priority'    => 10,
		'tags'        => array(
			esc_html__( 'preset hover', 'woodmart' ),
			esc_html__( 'grid layout template', 'woodmart' ),
			esc_html__( 'product skin', 'woodmart' ),
		),
		'requires'    => array(
			array(
				'key'     => 'products_hover_type',
...
Options::add_field(
	array(
		'id'           => 'product_custom_list',
		'name'         => esc_html__( 'Custom product layout for list', 'woodmart' ),
		'description'  => function_exists( 'woodmart_get_html_block_links' ) ? woodmart_get_html_block_links( 'edit.php?post_type=woodmart_layout&wd_layout_type_tab=loop_item&create_template', __( 'layout', 'woodmart' ) ) : '',
		'type'         => 'select',
		'section'      => 'products_styles_section',
		'select2'      => true,
...
Options::add_field(
	array(
		'id'       => 'product_custom_hover_notice',
		'type'     => 'notice',
		'style'    => 'info',
		'name'     => '',
		'content'  => esc_html__( 'The options below do not apply to custom product layouts, as they are managed via each layout’s individual settings.', 'woodmart' ),
		'section'  => 'products_styles_section',
		'priority' => 25,
	)
);
...
Options::add_field(
	array(
		...
		'name'        => esc_html__( 'Products border', 'woodmart' ),
...
Options::add_field(
	array(
		...
		'name'     => esc_html__( 'Border position', 'woodmart' ),
		'type'     => 'buttons',
		'section'  => 'products_styles_section',
		'group'    => esc_html__( 'Style', 'woodmart' ),
		'options'  => array(
...
Options::add_field(
	array(
		...
		'section'     => 'products_styles_section',
		'selectors'   => array(
			':is(.woodmart-archive-shop .wd-builder-off,.wd-wishlist-content,.related-and-upsells,.cart-collaterals,.wd-shop-product,.wd-fbt) .wd-products-with-bg, :is(.woodmart-archive-shop .wd-builder-off,.wd-wishlist-content,.related-and-upsells,.cart-collaterals,.wd-shop-product,.wd-fbt) .wd-products-with-bg :is(.wd-product,.wd-cat)' => array(
				'--wd-prod-bg:{{VALUE}};',
...
Options::add_field(
	array(
		...
		'options'     => array(
			...
			'two'  => array(
				'name'  => esc_html__( 'Two lines', 'woodmart' ),
				'value' => 'one',
			),
			'none' => array(
				'name'  => esc_html__( 'None', 'woodmart' ),
...
Options::add_field(
	array(
		...
		'hint'     => '<video data-src="' . WOODMART_TOOLTIP_URL . 'hide-categories-subcategories.mp4" autoplay loop muted></video>',
		'group'    => esc_html__( 'Elements', 'woodmart' ),
		'type'     => 'switcher',
		'section'  => 'categories_styles_section',
		'on-text'  => esc_html__( 'Yes', 'woodmart' ),
...
Options::add_field(
	array(
		...
		'priority'    => 20,
		'tags'        => array(
			esc_html__( 'grid columns', 'woodmart' ),
			esc_html__( 'items per row', 'woodmart' ),
			esc_html__( 'desktop grid', 'woodmart' ),
			esc_html__( 'product density', 'woodmart' ),
		),
		'requires'    => array(
			array(
				'key'     => 'shop_view',
...
Options::add_field(
	array(
		'id'          => 'products_spacing',
		'name'        => esc_html__( 'Space between grid products on desktop', 'woodmart' ),
		'description' => esc_html__( 'You can set different spacing between grid products on shop page', 'woodmart' ),
		'group'       => esc_html__( 'Grid', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_grid_section',
		'options'     => array(
		...
		'priority'    => 40,
		'tags'        => array(
			esc_html__( 'grid gap', 'woodmart' ),
			esc_html__( 'item margins', 'woodmart' ),
			esc_html__( 'product padding', 'woodmart' ),
			esc_html__( 'white space', 'woodmart' ),
		),
		'requires'    => array(
			array(
				'key'     => 'shop_view',
...
Options::add_field(
	array(
		...
		'name'        => esc_html__( 'Space between grid products on tablet', 'woodmart' ),
		'description' => esc_html__( 'You can set different spacing between grid products on shop page', 'woodmart' ),
		'group'       => esc_html__( 'Grid', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_grid_section',
...
Options::add_field(
	array(
		...
		'name'        => esc_html__( 'Space between grid products on mobile', 'woodmart' ),
		'description' => esc_html__( 'You can set different spacing between grid products on shop page', 'woodmart' ),
		'group'       => esc_html__( 'Grid', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_grid_section',
...
Options::add_field(
	array(
		'id'          => 'products_list_spacing',
		'name'        => esc_html__( 'Space between list products on desktop', 'woodmart' ),
		'description' => esc_html__( 'You can set different spacing between list products on shop page', 'woodmart' ),
		'group'       => esc_html__( 'Grid', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_grid_section',
		'options'     => array(
...
Options::add_field(
	array(
		'id'          => 'products_list_spacing_tablet',
		'name'        => esc_html__( 'Space between list products on tablet', 'woodmart' ),
		'description' => esc_html__( 'You can set different spacing between list products on shop page', 'woodmart' ),
		'group'       => esc_html__( 'Grid', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_grid_section',
...
Options::add_field(
	array(
		'id'          => 'products_list_spacing_mobile',
		'name'        => esc_html__( 'Space between list products on mobile', 'woodmart' ),
		'description' => esc_html__( 'You can set different spacing between list products on shop page', 'woodmart' ),
		'group'       => esc_html__( 'Grid', 'woodmart' ),
		'type'        => 'buttons',
		'section'     => 'products_grid_section',
...
Options::add_field(
	array(
		...
		'default'     => false,
		'tags'        => array(
			esc_html__( 'filter area', 'woodmart' ),
			esc_html__( 'product filtering', 'woodmart' ),
			esc_html__( 'widget bar', 'woodmart' ),
		),
		'priority'    => 10,
	)
);
...
Options::add_field(
	array(
		...
		'description'  => ( function_exists( 'woodmart_get_html_block_links' ) ? woodmart_get_html_block_links() : '' ) . esc_html__( 'You can create an HTML Block in Dashboard -> HTML Blocks and add Product filters page builder element there.', 'woodmart' ),
		'group'        => esc_html__( 'Content', 'woodmart' ),
		'type'         => 'select',
		'section'      => 'shop_filters_section',
		'select2'      => true,
...
Options::add_field(
	array(
		...
		'name'        => esc_html__( 'Shop filters area always opened on desktop', 'woodmart' ),
		...
		'priority'    => 50,
		't_tab'       => array(
			'id'    => 'shop_filters_always_open_tabs',
			'tab'   => esc_html__( 'Desktop', 'woodmart' ),
			'icon'  => 'xts-i-desktop',
			'style' => 'devices',
		),
...
Options::add_field(
	array(
		'id'          => 'shop_filters_always_open_tablet',
		'name'        => esc_html__( 'Shop filters area always opened on tablet', 'woodmart' ),
		'description' => esc_html__( 'If you enable this option the shop filters will be always opened on the shop page.', 'woodmart' ),
		'group'       => esc_html__( 'State', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'shop_filters_section',
...
Options::add_field(
	array(
		'id'          => 'shop_filters_always_open_mobile',
		'name'        => esc_html__( 'Shop filters area always opened on mobile', 'woodmart' ),
		'description' => esc_html__( 'If you enable this option the shop filters will be always opened on the shop page.', 'woodmart' ),
		'group'       => esc_html__( 'State', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'shop_filters_section',

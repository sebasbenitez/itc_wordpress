...
Options::add_field(
	array(
		...
		'priority'    => 10,
		'tags'        => array(
			esc_html__( 'bottom mobile menu', 'woodmart' ),
			esc_html__( 'app nav', 'woodmart' ),
			esc_html__( 'mobile bar', 'woodmart' ),
		),
...
Options::add_field(
	array(
		...
		'default'     => false,
		'tags'        => array(
			esc_html__( 'marketing popup', 'woodmart' ),
			esc_html__( 'discount popup', 'woodmart' ),
		),
		'priority'    => 10,
	)
);
...
Options::add_field(
	array(
		...
		'default'     => false,
		'tags'        => array(
			esc_html__( 'cookie notice', 'woodmart' ),
			esc_html__( 'privacy notice', 'woodmart' ),
			esc_html__( 'gdpr banner', 'woodmart' ),
			esc_html__( 'tracking info', 'woodmart' ),
		),
		'priority'    => 10,
		'class'       => 'xts-tooltip-bordered',
	)
...
Options::add_field(
	array(
		...
		'default'     => false,
		'tags'        => array(
			esc_html__( 'top promo', 'woodmart' ),
			esc_html__( 'discount bar', 'woodmart' ),
		),
		'priority'    => 10,
	)
);

...
Options::add_field(
	array(
		...
		'name'        => esc_html__( 'Mark product as "New" for period', 'woodmart' ),
		'group'       => esc_html__( 'New status', 'woodmart' ),
...
Options::add_field(
	array(
		...
		'default'     => '1',
		'tags'        => array(
			esc_html__( 'fast buy', 'woodmart' ),
			esc_html__( 'instant purchase', 'woodmart' ),
			esc_html__( 'quick add variable', 'woodmart' ),
		),
		'priority'    => 10,
	)
);
...
Options::add_field(
	array(
		...
		'off-text'    => esc_html__( 'No', 'woodmart' ),
		'tags'        => array(
			esc_html__( 'collapse swatches', 'woodmart' ),
			esc_html__( 'variation limit', 'woodmart' ),
		),
		'priority'    => 50,
	)
);
...
Options::add_field(
	array(
		...
		'off-text'    => esc_html__( 'No', 'woodmart' ),
		'tags'        => array(
			esc_html__( 'variation images for swatches', 'woodmart' ),
			esc_html__( 'gallery swatches', 'woodmart' ),
		),
		'priority'    => 70,
	)
);
...
Options::add_field(
	array(
		...
		'description' => esc_html__( 'Enables a custom post type for adding labels to products. You can find it under Dashboard → Products → Custom Labels.', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'product_labels_section',
		'default'     => '0',
		'tags'        => array(
			esc_html__( 'product badges', 'woodmart' ),
			esc_html__( 'product stickers', 'woodmart' ),
		),
		'priority'    => 20,
...
Options::add_field(
	array(
		'id'          => 'sale_label',
		'name'        => esc_html__( '"Sale" label on products', 'woodmart' ),
		'group'       => esc_html__( 'Sale', 'woodmart' ),
		'description' => esc_html__( 'Your sale products will have a badge with "Sale" label.', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'product_labels_section',
		'default'     => '1',
		'priority'    => 30,
...
Options::add_field(
	array(
		...
		'type'        => 'color',
		'section'     => 'product_labels_section',
		'selector_bg' => '.wd .product-label.onsale',
		'default'     => array(),
		'priority'    => 50,
		'class'       => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'product_labels_section',
		'selector' => '.wd .product-label.onsale',
		'default'  => array(),
		'priority' => 60,
		'class'    => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'type'        => 'color',
		'section'     => 'product_labels_section',
		'selector_bg' => '.wd .product-label.new',
		'default'     => array(),
		'priority'    => 80,
		'class'       => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'type'        => 'color',
		'section'     => 'product_labels_section',
		'selector_bg' => '.wd .product-label.featured',
		'default'     => array(),
		'priority'    => 110,
		'class'       => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'product_labels_section',
		'selector' => '.wd .product-label.featured',
		'default'  => array(),
		'priority' => 120,
		'class'    => 'xts-col-6',
	)
...
Options::add_field(
	array(
		'id'          => 'stock_label',
		'name'        => esc_html__( '"Out of stock" label on products', 'woodmart' ),
		'group'       => esc_html__( 'Out of stock', 'woodmart' ),
		'description' => esc_html__( 'Your out of stock products will have a badge with "Sold out" label.', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'product_labels_section',
		'default'     => '1',
		'priority'    => 130,
...
Options::add_field(
	array(
		...
		'type'        => 'color',
		'section'     => 'product_labels_section',
		'selector_bg' => '.wd .product-label.out-of-stock',
		'default'     => array(),
		'priority'    => 140,
		'class'       => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'product_labels_section',
		'selector' => '.wd .product-label.out-of-stock',
		'default'  => array(),
		'priority' => 150,
		'class'    => 'xts-col-6',
	)
...
Options::add_field(
	array(
		'id'          => 'attribute_label',
		'name'        => esc_html__( '"Attribute" label on products', 'woodmart' ),
		'group'       => esc_html__( 'Attribute', 'woodmart' ),
		'description' => esc_html__( 'Your attribute labels will be displayed on the product image.', 'woodmart' ),
		'type'        => 'switcher',
		'section'     => 'product_labels_section',
		'default'     => '1',
		'priority'    => 160,
...
Options::add_field(
	array(
		...
		'type'        => 'color',
		'section'     => 'product_labels_section',
		'selector_bg' => '.wd .product-label.attribute-label:not(.label-with-img)',
		'default'     => array(),
		'priority'    => 170,
		'class'       => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'type'     => 'color',
		'section'  => 'product_labels_section',
		'selector' => '.wd .product-label.attribute-label:not(.label-with-img)',
		'default'  => array(),
		'priority' => 180,
		'class'    => 'xts-col-6',
	)
...
Options::add_field(
	array(
		...
		'default'     => '1',
		'tags'        => array(
			esc_html__( 'preview product', 'woodmart' ),
			esc_html__( 'quick preview', 'woodmart' ),
			esc_html__( 'product popup', 'woodmart' ),
		),
		'priority'    => 10,
	)
);
...
Options::add_field(
	array(
		...
		'off-text'    => esc_html__( 'No', 'woodmart' ),
		'tags'        => array(
			esc_html__( 'product comparison', 'woodmart' ),
			esc_html__( 'side by side', 'woodmart' ),
			esc_html__( 'product differences', 'woodmart' ),
		),
		'priority'    => 10,
	)
);
...
Options::add_field(
	array(
		...
		'default'  => 'layout-1',
		'tags'     => array(
			esc_html__( 'cart summary style', 'woodmart' ),
			esc_html__( 'totals design', 'woodmart' ),
		),
		'priority' => 10,
	)
);

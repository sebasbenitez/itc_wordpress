...
class Widgets {
	...
	private function import_widgets() {
		...
		if ( 'elementor' === $this->helpers->get_page_builder() && file_exists( $this->helpers->get_version_folder_path( $this->version ) . 'widgets-elementor.json' ) ) {
			$file_path = $this->helpers->get_file_path( 'widgets-elementor.json', $this->version );
		} elseif ( 'gutenberg' === $this->helpers->get_page_builder() && file_exists( $this->helpers->get_version_folder_path( $this->version ) . 'widgets-gutenberg.json' ) ) {
			$file_path = $this->helpers->get_file_path( 'widgets-gutenberg.json', $this->version );
		}
		...
		$widgets_data = $this->helpers->links_replace( $widgets_data, '\\/', $this->version );

...
class Mega_Menu_Walker extends Walker_Nav_Menu {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		if ( 'sized' === $design ) {
			woodmart_enqueue_inline_style( 'dropdown-sized' );
		}

		if ( 'full-width' === $design ) {
			woodmart_enqueue_inline_style( 'dropdown-full-width' );
		}
		...
		if ( $is_nav_mobile && ( $args->walker->has_children || $block ) ) {
			woodmart_enqueue_inline_style( 'nav-opener' );
		}

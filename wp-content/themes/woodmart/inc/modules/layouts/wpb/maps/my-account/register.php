...
if ( ! function_exists( 'woodmart_get_vc_map_my_account_register' ) ) {
	/**
	 * My account register map.
	 */
	function woodmart_get_vc_map_my_account_register() {
		...
		return array(
			'base'        => 'woodmart_my_account_register',
			'name'        => esc_html__( 'Register', 'woodmart' ),
			'category'    => woodmart_get_tab_title_category_for_wpb( esc_html__( 'My account elements', 'woodmart' ) ),
			'description' => esc_html__( 'Registration form for new users', 'woodmart' ),
			'icon'        => WOODMART_ASSETS . '/images/vc-icon/ma-icons/register.svg',
			'params'      => array(
				// Title.
				array(

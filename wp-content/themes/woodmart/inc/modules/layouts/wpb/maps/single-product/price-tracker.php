...
if ( ! function_exists( 'woodmart_get_vc_map_single_product_price_tracker' ) ) {
	/**
	 * Price tracker map.
	 */
	function woodmart_get_vc_map_single_product_price_tracker() {
		...
		return array(
			'base'        => 'woodmart_single_product_price_tracker',
			'name'        => esc_html__( 'Price tracker button', 'woodmart' ),
			'category'    => woodmart_get_tab_title_category_for_wpb( esc_html__( 'Single product elements', 'woodmart' ), 'single_product' ),
			'description' => esc_html__( 'Allows users to subscribe to price tracker notifications.', 'woodmart' ),
			'icon'        => WOODMART_ASSETS . '/images/vc-icon/sp-icons/sp-pt.svg',
			'params'      => array(
				array(

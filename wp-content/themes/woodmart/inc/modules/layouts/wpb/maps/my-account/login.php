...
if ( ! function_exists( 'woodmart_get_vc_map_my_account_login' ) ) {
	/**
	 * My account login map.
	 */
	function woodmart_get_vc_map_my_account_login() {
		...
		return array(
			'base'        => 'woodmart_my_account_login',
			'name'        => esc_html__( 'Login', 'woodmart' ),
			'category'    => woodmart_get_tab_title_category_for_wpb( esc_html__( 'My account elements', 'woodmart' ) ),
			'description' => esc_html__( 'Login form for user authentication', 'woodmart' ),
			'icon'        => WOODMART_ASSETS . '/images/vc-icon/ma-icons/login.svg',
			'params'      => array(
				// Title.
				array(

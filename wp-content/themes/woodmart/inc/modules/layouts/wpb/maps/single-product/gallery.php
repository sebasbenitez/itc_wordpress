		...
		return array(
			...
			'params'      => array(
				...
				array(
					...
					'type'       => 'woodmart_title_divider',
					'param_name' => 'labels_divider',
				),

				array(
					'heading'     => esc_html__( 'Labels', 'woodmart' ),
					'type'        => 'woodmart_switch',
					'param_name'  => 'product_labels',
					'true_state'  => 'yes',
					'false_state' => 'no',
					'default'     => 'yes',
				),
...
add_filter( 'vc_autocomplete_woodmart_single_product_gallery_product_id_callback', 'woodmart_product_id_autocomplete_suggester_new', 10, 1 );
add_filter( 'vc_autocomplete_woodmart_single_product_gallery_product_id_render', 'woodmart_product_id_autocomplete_render', 10, 1 );

...
if ( ! function_exists( 'woodmart_get_vc_map_single_post_comments' ) ) {
	/**
	 * Post comments map.
	 */
	function woodmart_get_vc_map_single_post_comments() {
		...
		return array(
			'base'        => 'woodmart_single_post_comments',
			'name'        => esc_html__( 'Post comments', 'woodmart' ),
			'category'    => woodmart_get_tab_title_category_for_wpb( esc_html__( 'Posts elements', 'woodmart' ) ),
			'description' => esc_html__( 'List of the post user comments', 'woodmart' ),
			'icon'        => WOODMART_ASSETS . '/images/vc-icon/post-icons/post-comments.svg',
			'params'      => array(
				...
				array(
					...
					'selectors'        => array(
						'{{WRAPPER}} .wd-post-comments .comments-title' => array(
							'color: {{VALUE}};',
						),
					),

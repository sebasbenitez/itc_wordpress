	...
	function woodmart_get_vc_map_single_product_price() {
		...
		return array(
			...
			'params'      => array(
				...
				$typography_price['text_decoration'],
				...
				$typography_old_price['text_decoration'],
				...
				$typography_suffix['text_decoration'],
...
add_filter( 'vc_autocomplete_woodmart_single_product_price_product_id_callback', 'woodmart_product_id_autocomplete_suggester_new', 10, 1 );
add_filter( 'vc_autocomplete_woodmart_single_product_price_product_id_render', 'woodmart_product_id_autocomplete_render', 10, 1 );

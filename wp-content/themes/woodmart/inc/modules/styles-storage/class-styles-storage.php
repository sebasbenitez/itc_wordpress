...
class Styles_Storage {
	...
	public function file_css() {
		if ( isset( $this->data['path'] ) && $this->data['path'] ) {
			wp_register_style( 'xts-style-' . $this->data_name, $this->get_file_url( $this->data['path'] ), array(), $this->current_theme_version );

			wp_style_add_data( 'xts-style-' . $this->data_name, 'path', $this->get_file_path( $this->data['path'] ) );

			wp_enqueue_style( 'xts-style-' . $this->data_name );
		}
	}
	...
	public function inline_css() {
		if ( trim( $this->css ) ) {
			?>
			<style id="wd-style-<?php echo esc_attr( $this->data_name ); ?>-inline-css" data-type="wd-style-<?php echo esc_attr( $this->data_name ); ?>">
	...
	public function check_credentials() {
		...
		if ( ( 'valid' === $data_status || 'requested' === $credentials_status ) && ! $_POST ) { // phpcs:ignore WordPress.Security.NonceVerification.Missing
			return false;
		}

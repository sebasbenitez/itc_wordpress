...
return apply_filters(
	...
	array(
		...
		'quick_add_to_cart'             => array(
			...
			'selector'       => 'html .wd-product.wd-hover-quick .wd-add-btn>a, html .wd-product.wd-hover-quick.wd-quantity-overlap div.quantity :is(input[type],.btn)',
			'selector-hover' => 'html .wd-product.wd-hover-quick .wd-add-btn>a:hover, html .wd-product.wd-hover-quick.wd-quantity-overlap div:hover > div.quantity :is(input[type],.btn), 
		...
		'fw-button_add_to_cart'         => array(
			...
			'selector'       => 'html .wd-product.wd-hover-fw-button .wd-add-btn>a, html .wd-product.wd-hover-fw-button.wd-quantity-overlap div.quantity :is(input[type],.btn)',
			'selector-hover' => 'html .wd-product.wd-hover-fw-button .wd-add-btn>a:hover, html .wd-product.wd-hover-fw-button.wd-quantity-overlap div:hover > div.quantity :is(input[type],.btn), 
		...
		'quick_shop_add_to_cart'        => array(
			...
			'selector'       => 'html .quick-shop-form .single_add_to_cart_button, html .quick-shop-form div.quantity :is(input[type],.btn)',
			'selector-hover' => 'html .quick-shop-form .single_add_to_cart_button:hover, html .quick-shop-wrapper .quick-shop-form div:hover > div.quantity :is(input[type],.btn), 
		...
		'sticky_add_to_cart'            => array(
			...
			'selector'       => 'html .wd-sticky-btn-cart .single_add_to_cart_button, html .wd-sticky-btn-cart .wd-sticky-add-to-cart, html .wd-sticky-btn.wd-quantity-overlap div.quantity :is(input[type],.btn)',
			'selector-hover' => 'html .wd-sticky-btn-cart .single_add_to_cart_button:hover, html .wd-sticky-btn-cart .wd-sticky-add-to-cart:hover, html .wd-sticky-btn.wd-quantity-overlap .cart:hover > div.quantity :is(input[type],.btn), html .wd-sticky-btn.wd-quantity-overlap .cart:hover > div.quantity+.button',
		),
		'review_submit'                 => array(
			'title'          => 'Review submit',

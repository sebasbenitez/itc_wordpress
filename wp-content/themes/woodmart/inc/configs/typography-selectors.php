...
return apply_filters(
	...
	array(
		...
		'page_title_bredcrumps'                  => array(
			...
			'selector'       => 'html .wd-page-title .wd-breadcrumbs :is(a,span), html .wd-page-title .breadcrumb li::after',
			'selector-hover' => 'html .wd-page-title .wd-breadcrumbs a:hover',
		),
		'checkout_steps'                         => array(
			'title'          => 'Checkout steps',
			'selector'       => 'html .wd-checkout-steps',
			'selector-hover' => 'html .wd-checkout-steps li a:hover',
		),
		...
		'product_title'                          => array(
			...
			'selector'       => 'html .wd-product .wd-entities-title, html .wd-product.product-list-item .wd-entities-title',

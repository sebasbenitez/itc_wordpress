...
if ( ! function_exists( 'woodmart_shortcode_categories' ) ) {
	...
	function woodmart_shortcode_categories( $atts ) {
		$parsed_atts = shortcode_atts(
			array_merge(
				...
				array(
					...
					'enable_nav_items_background'        => 'no',
					'enable_nav_items_background_hover'  => 'no',
					'enable_nav_items_background_active' => 'no',
					'enable_nav_items_border'            => 'no',
					'enable_nav_items_border_hover'      => 'no',
					'enable_nav_items_border_active'     => 'no',
					'enable_nav_items_box_shadow'        => 'no',
					'enable_nav_items_box_shadow_hover'  => 'no',
					'enable_nav_items_box_shadow_active' => 'no',
					'nav_disable_active_style'           => 'no',
				)
			),
			$atts
		);
		...
		if ( ! empty( $nav_items_gap ) ) {
			$parsed_atts['items_gap'] = $nav_items_gap;
		}

		if ( ! empty( $nav_style ) ) {
			$parsed_atts['nav_style'] = $nav_style;
		}

		if ( ! empty( $menu_classes ) ) {
			$parsed_atts['menu_classes'] = $menu_classes;
		}
		...
		if ( 'navigation' === $type ) {
			...
			$items_bg_activated      = 'yes' === $parsed_atts['enable_nav_items_background'] || 'yes' === $parsed_atts['enable_nav_items_background_hover'] || 'yes' === $parsed_atts['enable_nav_items_background_active'];
			$items_border_active     = 'yes' === $parsed_atts['enable_nav_items_border'] || 'yes' === $parsed_atts['enable_nav_items_border_hover'] || 'yes' === $parsed_atts['enable_nav_items_border_active'];
			$items_box_shadow_active = 'yes' === $parsed_atts['enable_nav_items_box_shadow'] || 'yes' === $parsed_atts['enable_nav_items_box_shadow_hover'] || 'yes' === $parsed_atts['enable_nav_items_box_shadow_active'];

			if ( $items_bg_activated || $items_box_shadow_active || $items_border_active ) {
				$parsed_atts['menu_classes'] .= ' wd-add-pd';
			}

			if ( 'yes' === $parsed_atts['nav_disable_active_style'] ) {
				$parsed_atts['menu_classes'] .= ' wd-dis-act';
			}

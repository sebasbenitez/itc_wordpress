...
class WOODMART_Widget_Layered_Nav extends WPH_Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( ! is_shop() && ! is_product_taxonomy() && 'default' === $template ) {
			return;
		}
	...
	protected function layered_nav_checkbox_list( $terms, $taxonomy, $query_type, $instance ) {
		...
		if ( isset( $categories[0] ) && $categories[0] && ! in_array( $current_cat_id, $categories ) && $is_on_shop ) { // phpcs:ignore WordPress.PHP.StrictInArray.MissingTrueStrict
			return;
		}
